      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
          ...
          <div className="text-sm text-blue-600 dark:text-blue-300">
            {selectedSites.slice(0, 3).map(site => site.name).join(', ')}
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            {allTags.length > 0 && (
              <div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">常用标签:</div>
        ...
        {/* 描述编辑 */}
        <div>
          <label htmlFor="batch-description" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            描述 (将替换所有选中网站的描述)
          </label>
          <textarea
